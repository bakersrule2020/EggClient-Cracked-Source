...
//Emm Button Api https://github.com/ToxicStuff/emmVRC-Rewrite-Quest
namespace EggClient
{
    ...
    public class MenuPage
    {
        ...
        {
            ButtonAPI.GetMenuStateControllerInstance().Method_Public_Void_String_ObjectPublicStBoAc1ObObUnique_Boolean_EnumNPublicSealedvaNoLeRiBoIn6vUnique_0(page.field_Public_String_0, page.field_Protected_ObjectPublicStBoAc1ObObUnique_0, false, UIPage.EnumNPublicSealedvaNoLeRiBoIn6vUnique.Right);
        }
    ...
    public class WingPage
    {
        ...
        public WingPage(string menuName, string pageTitle, bool root = true, bool backButton = true, bool preserveColor = false)
        {
            ...
            {
                ButtonAPI.GetMenuStateControllerInstance().Method_Public_Void_String_ObjectPublicStBoAc1ObObUnique_Boolean_EnumNPublicSealedvaNoLeRiBoIn6vUnique_0(rightPage.field_Public_String_0, rightPage.field_Protected_ObjectPublicStBoAc1ObObUnique_0, false, UIPage.EnumNPublicSealedvaNoLeRiBoIn6vUnique.Left);
        ...
        {
            typeof(UIPage).GetMethods().First(a => Extensions.CheckUsing(a, "Method_Public_Void_UIPage_0")).Invoke(leftPage, null);
        }
        public void CloseRightMenu()
        {
            typeof(UIPage).GetMethods().First(a => Extensions.CheckUsing(a, "Method_Public_Void_UIPage_0")).Invoke(rightPage, null);
        }
    }
}
